...
final class PlatControllerTest extends WebTestCase
{
    ...
    /** @var EntityRepository<Plat> $platRepository */
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'plat[typePlat]' => 'Testing',
            'plat[price]' => 'Testing',
            'plat[isActive]' => 'Testing',
            'plat[createAt]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'plat[name]' => 'Something New',
            'plat[description]' => 'Something New',
            'plat[typePlat]' => 'Something New',
            'plat[price]' => 'Something New',
            'plat[isActive]' => 'Something New',
            'plat[createAt]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getTypePlat());
